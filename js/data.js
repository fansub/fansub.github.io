...
var MAL_CDN = "https://myanimelist.cdn-dena.com/images/anime/"
...
function buildPage(arr, type) {
	...
	if(array.length === 0) {
		...
		for(i = 0; i < array.length; ++i) {
			...
			dataTable += '<li role="presentation"><img src="' + MAL_CDN + array[i].image + '" onerror="cantLoadImage(this, \'' + encodeText(array[i].name) + '\')" ></li>';
			dataTable += '</ul></div></td>';
			dataTable += '<td>';
